				...
				<tr>
					<td><span style="text-align: center; font-family: serif;">
							<c:forEach items="${top3}" var="travel">
								<a href="getTravelSpotuser.do?seq=${travel.seq}" style="text-decoration: none;">
										...
										<a href="getTravelSpotuser.do?seq=${travel.seq}"
											...
											<article>
												...
												<table>
													...
													<tr>
														<td colspan="2" align="left"><input type="submit" value="즐겨찾기 추가" class="b" id ="bookMark"></td>
														<c:if test="${ checkMark == 1 && checkseq == 1 && checkMark == checkseq && checkseq == travel.seq}">  
															<script>
