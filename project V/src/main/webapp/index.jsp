			...
			<div class="col-md-10 col-lg-8 col-xl-7">
				<div class="post-preview">
					...
					<h4 class="post-subtitle b">
						<br> 로그인 회원가입 이후 더 <br> 
						<span class="c" style="font-size: 50px;">"<span class="b" style="font-size: 26px; font-weight: bold;">&nbsp;다양한&nbsp;</span>"</span><br>
		...
		<div class="row gx-4 gx-lg-5 justify-content-center">
			<div class="col-md-10 col-lg-8 col-xl-7">
				<div class="post-preview">
					...
					<h4 class="post-subtitle b">
					<br>카카오 맵 API를 활용하여<br>각 페이지별 관광지에<br> 각 위치에 마커로 표시합니다.<br> 
					관광지의 위치 정보를<br> 알고싶다면 지도를 확대 하여 상세 관광지의 위치를 확인하세요~!
						<style>
.login-link {
	text-decoration: none;
	color: inherit;
		...
		<div class="row gx-4 gx-lg-5 justify-content-center">
			<div class="col-md-10 col-lg-8 col-xl-7">
				<div class="post-preview">
					...
					<h4 class="post-subtitle b">
						<br> 즐겨찾기 저장후 나의<br> 여행장소를 지도에<br>
						<span class="c" style="font-size: 50px;">"<span class="b" style="font-size: 26px; font-weight: bold;">&nbsp;한 눈에&nbsp;</span>"</span><br>
						<div style="line-height: 9px;"><br></div>
