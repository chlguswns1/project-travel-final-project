...
insert into users(MEMBER_SEQ,MEMBER_ID, MEMBER_PW, MEMBER_NAME, MEMBER_EMAIL,MEMBER_EMAIL_GET,MEMBER_PHONE) values('3','min','1111','강민수','min123','naver.com','0101111')
