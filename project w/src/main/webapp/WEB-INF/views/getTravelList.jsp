...
<body>
    ...
    <input class="form-control me-sm-2" type="text" placeholder="Search" name="searchKeyword">
				...
				<tr>
					<td><span style="text-align: center; font-family: serif;">
							<c:forEach items="${top3}" var="travel">
								<a href="getTravelSpotNonUser.do?seq=${travel.seq}" style="text-decoration: none;">
